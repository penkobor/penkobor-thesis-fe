...
export class MasterDegreePrograms extends React.Component<{},{}> {

  preview1 = require('../../../assets/11-prihlaska.jpg');
  preview2 = require('../../../assets/12-prijimac.jpg');
  preview3 = require('../../../assets/11-prihlaska.jpg');
  preview4 = require('../../../assets/13-proc.jpg');
  preview5 = require('../../../assets/12-prijimac.jpg');
  ...
  render(){
    ...
    <div className='p-5 ml-8 bg-white rounded'>
      <h1>Master's degree programmes </h1>
      <h2>After completing bachelor's program, it takes two years to earn Master of Science (MSc) program.</h2>
      <table>
        <tr> 
          <td className = 'p-5'><Preview img={this.preview1} text= 'Electrical Engineering, Power Engineering and Management'  unavailable={true}/></td>
          <td className = 'p-5'><Preview img={this.preview2} text= 'Electronics and Communications' unavailable={true}/></td> 
          <td className = 'p-5'><Preview img={this.preview3} text= 'Cybernetics and Robotics' unavailable={true}/></td> 
        </tr>
        <tr> 
          <td className = 'p-5'><Preview img={this.preview4} text= 'Open Informatics' unavailable={true}/></td>
          <td className = 'p-5'><Preview img={this.preview5} text= 'Aerospace Engineering' unavailable={true}/></td>
          <td className = 'p-5'><Preview img={this.preview5} text= 'Medical electronics and bioinformatics' unavailable={true} /></td> 
        </tr>
      </table>
      ...
      {/* <BachelorDegreePrograms></BachelorDegreePrograms> */}
